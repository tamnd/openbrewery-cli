...
```
openbrewery <command> [arguments] [flags]
```

Run `openbrewery <command> --help` for the full flag list on any command. This
...
per operation you declare in `openbrewery/domain.go`.
