...
Most of these come down to network reality or how openbrewery serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openbrewery rate-limits like any public site. openbrewery already paces
...
Where a surface is gated, openbrewery reads a cookie or token you supply
...
`openbrewery`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openbrewery actually did
